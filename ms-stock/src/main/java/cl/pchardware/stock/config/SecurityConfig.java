package cl.pchardware.stock.config;
 ...
 * │ /api/v1/inventarios/**        │ GET    │ ADMIN, TASADOR                     │
 * │ /api/v1/inventarios/**        │ POST   │ ADMIN                              │
 * │ /api/v1/inventarios/**        │ PUT    │ ADMIN                              │
 * │ /api/v1/inventarios/**        │ DELETE │ ADMIN                              │
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // Lectura de inventarios: cualquier rol autenticado
                .requestMatchers(HttpMethod.GET, "/api/v1/inventarios/**")
                    .hasAnyRole("Admin", "Tasador", "Cliente")

                // Escritura de inventarios: solo Administrador y Tasador
