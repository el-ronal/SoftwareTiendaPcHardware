...
cls
echo ====================================================
echo         TIENDA PC - DESPLIEGUE EN DOCKER
echo ====================================================
echo.
...
echo       (common, eureka, api-gateway, ms-usuarios, ms-catalogo, ms-stock, ms-pedidos, ms-pagos, ms-envios, ms-tasacion, ms-garantias, ms-devoluciones, ms-soporte, ms-armado, ms-notificaciones)
echo.
...
echo       Iniciando microservicios (, ms-usuarios, ms-catalogo, ms-stock, ms-pedidos, ms-pagos, ms-envios, ms-tasacion, ms-garantias, ms-devoluciones, ms-soporte, ms-armado, ms-notificaciones)...
docker compose up -d ms-usuarios ms-catalogo ms-stock ms-pedidos ms-pagos ms-envios ms-tasacion ms-garantias ms-devoluciones ms-soporte ms-armado ms-notificaciones kafka-ui
echo.
...
echo   2. Probar endpoints de ms-usuarios, ms-catalogo, ms-stock, ms-pedidos, ms-pagos, ms-envios, ms-tasacion, ms-garantias, ms-devoluciones, ms-soporte, ms-armado, ms-notificaciones
echo.
